function [sol_u, sol_l, nplas, tplas, convNRvec, convFlag, C, ittot] = ...
    solve_NL_CM(nn, ni, K, B, theta, rhs, interfData, areaiR, sol0, state0, nplas0, tplas0, ...
    ...
    while (~exitFlag)
        ...
        f = @(x,iter) cpt_residual(K,B,theta, N, M, rhs,ndir,dir,state0,sol0,areaiR, ...
                                   cohes,phi,tol_duT,interfData,iter,x);
...
% TODO: rewrite this function from scratch to implement semismooth Newton
function [res,J] = cpt_residual(K,B,theta,rhs,ndir,dir,state0,sol0,areaiR, ...
                                cohes,phi,tol_duT,interfData,iter,sol)
