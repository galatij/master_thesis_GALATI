function [itGlo, convAll] = ...
    ...
    for iStep = 1 : length(steps)-1
        ...
        while (tcurr < tend)
            ...
            [sol_u, sol_l, nplas, tplas, convNRvec, convFlag, C, iter] = ...
                solve_NL_CM(nn, ni, K, Bt, rhscurr, interfData, areaiR, sol0, state0, nplas0, tplas0, ...
                            ndir, dir, dirvalcurr, actSetItMax, noConvItMax, itmax_NR, tol_NR, ...
        ...
        if (SAVEVTK)
            ...
            IDprint = IDprint + 1;
            fileName = sprintf('result_LM_%3.3i.vtk', IDprint);
