function [nedges, edges, edgeData, f2e, interfData] = edgeManager(ni, interf, coord, interfData)
    ...
    e2f = f2e';
    edgeData = repmat(struct('n1', 1, 'n2', 1, 'len', 1, 'normal', zeros(3,1), 'bar', zeros(3,1)), nedges, 1);
